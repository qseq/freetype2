...
#define T1_FIELD_CALLBACK( _ident, _name, _dict )       \
  ...
  typedef FT_Error
  (*PS_Builder_Check_Points_Func)( PS_Builder*  builder,
                                   FT_Int       count );

  typedef void
  (*PS_Builder_Add_Point_Func)( PS_Builder*  builder,
                                FT_Pos       x,
                                FT_Pos       y,
                                FT_Byte      flag );

  typedef FT_Error
  (*PS_Builder_Add_Point1_Func)( PS_Builder*  builder,
                                 FT_Pos       x,
                                 FT_Pos       y );

  typedef FT_Error
  (*PS_Builder_Add_Contour_Func)( PS_Builder*  builder );

  typedef FT_Error
  (*PS_Builder_Start_Point_Func)( PS_Builder*  builder,
                                  FT_Pos       x,
                                  FT_Pos       y );

  typedef void
  (*PS_Builder_Close_Contour_Func)( PS_Builder*  builder );
...
#define PS_MAX_SUBRS_CALLS     16   /* maximum subroutine nesting;         */
  ...
  typedef struct  PS_Decoder_FuncsRec_
  {
    void
    ...
    FT_Error
    (*prepare)( PS_Decoder*   decoder,
                FT_Size       size,
                FT_UInt       glyph_index );

    void
    (*done)( PS_Decoder  decoder );
